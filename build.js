...
const jsFiles = ['background.js', 'content.js', 'sidebar.js', 'options.js', 'offscreen.js'];
const copyFiles = ['manifest.json', 'sidebar.html', 'sidebar.css', 'options.html', 'options-base.css', 'offscreen.html'];
